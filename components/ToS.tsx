...
export default function ToS() {
  return (
    ...
    <Box m={55} textAlign="left">
      ...
      Emblem Vault® Terms of Service (Updated: April 18, 2023)
      </Heading>

      <Text m={25} fontSize="lg">Last Updated: April 18, 2023</Text>

      <Text m={25} fontSize="lg">Emblem is an NFT Vault protocol solution that allows you to deploy your personal “Vaults” on the Ethereum blockchain for securing and accessing digital assets across different blockchains. Unspecified, Inc., a company organized under the laws of the State of North Carolina, and doing business as Emblem (“Emblem,” “we,” “us,” “our”) owns and operates Emblem, the Site(s) (including emblem.pro and emblem.finance, and other products, services, or Smart Contracts that we make available through our Site(s) or applications.</Text>
      
      <Text m={25} fontWeight={"bold"} fontSize="lg">PLEASE READ THESE TERMS CAREFULLY AS THEY CONSTITUTE A BINDING LEGAL AGREEMENT BETWEEN YOU AND EMBLEM. ASPECTS OF THESE TERMS LIMIT CERTAIN RIGHTS, INCLUDING THE RIGHT TO MAINTAIN A COURT ACTION, THE RIGHT TO A JURY TRIAL, THE RIGHT TO PARTICIPATE IN ANY FORM OF CLASS OR REPRESENTATIVE CLAIM, THE RIGHT TO ENGAGE IN DISCOVERY EXCEPT AS PROVIDED IN AAA (AMERICAN ARBITRATION ASSOCIATION) RULES, AND THE RIGHT TO CERTAIN REMEDIES AND FORMS OF RELIEF.</Text>

      <Text m={25} fontWeight={"bold"} fontSize="lg">I. THIS IS A BINDING LEGAL AGREEMENT BETWEEN YOU AND EMBLEM</Text>

      <Text m={25} fontSize="lg">These Terms of Service (“Terms” or “Agreement”) are entered into between You and Emblem. These Terms govern your access to and use of the Site(s), interaction with our Smart Contracts, Vaults, and any other software, websites, applications, API’s, webtools, third party tools, experiences, features, or functionalities provided on or in connection with the Site(s) and all successor Site(s) thereto (collectively, the “Services”). Without limitation, these Terms govern your voluntary use our Services for any purpose, including to deploy Non-Fungible Token (“NFT”) “Vaults,” upload content, and configure, interact, or perform functions involving our Site or Smart Contracts. For the purposes of these Terms, “you” includes both you, the person or entity, and the digital wallet that you use for the purposes of using the services.</Text> 

      <Text m={25} fontWeight="bold" fontSize="lg">YOU ACKNOWLEDGE AND REAFFIRM YOUR AGREEMENT TO THESE TERMS EACH TIME YOU ACCESS THE SITE, USE THE SERVICES, LOG ONTO TO THE SITE, CONNECT YOUR DIGITAL WALLET THROUGH THE SITE, INITIATE TRANSACTIONS FROM YOUR DIGITAL WALLET THROUGH THE SITE, DEPLOY OR INTERACT WITH A VAULT, OR OTHERWISE INVOKE OR INTERACT WITH THE SITE. YOU MUST IMMEDIATELY AND PERMANENTLY DISCONTINUE YOUR ACCESS AND USE OF THE SITE IF YOU DO NOT AGREE TO THESE TERMS.</Text> 

      <Text m={25} fontWeight="bold" fontSize="lg">II. MODIFICATIONS AND ADDITIONS TO THESE TERMS</Text>
      
      <Text m={25} fontSize="lg">Emblem reserves the right to change or modify these Terms at any time and in our sole discretion. By continuing to access or use the Service, you confirm your acceptance of the revised Terms and all of the terms incorporated therein by reference effective as of the date these Terms are updated. It is your sole responsibility to review the Terms from time to time to view such changes and to ensure that you understand the terms and conditions that apply when you access or use the Service. We sometimes need to provide additional terms for specific services (and all such services are deemed part of the “Service” hereunder and shall also be subject to these Terms). Those additional terms and conditions, which are available in connection with the relevant service and hereby incorporated by reference, then become part of your agreement with us if you use those Services. In the event of a conflict between these Terms and any additional applicable terms we may provide for a specific service, such additional terms shall control for that specific service.</Text> 

      <Text m={25} fontWeight="bold" fontSize="lg">III. CAPACITY AND AUTHORITY TO USE THE SERVICES</Text>

      <Text m={25} fontSize="lg">You expressly represent and warrant that you have the right, authority, and capacity to enter into this agreement on behalf of yourself and any third-party individual or organization for which you are acting as an authorized agent. You expressly represent and warrant that you are over the age of majority in your jurisdiction and at least over the age of thirteen (13). If you are under eighteen (18) years old you may only use the Services through a parent or guardian’s Account and upon their separate agreement to these Terms. It is prohibited to use our Service if you are under 13 years old.</Text>

      <Text m={25} fontSize="lg">If you use our Services from or on behalf of a company, collective, digital autonomous
...
liability stemming from the use of such technical instruments.</Text>

    <Text m={25} fontWeight={"bold"} fontSize="lg">IV. YOUR RESPONSIBILITIES</Text>

    <Text m={25} fontSize="lg">In addition to other responsibilities and obligations provided in these Terms, you are solely
...
legal opinion.</Text>
    ...
    <Text m={25} fontWeight={"bold"} fontSize="lg">V. THE VAULT SERVICES RELY ON PUBLIC BLOCKCHAINS AND OTHER EXPERIMENTAL
TECHNOLOGIES</Text>

  <Text m={25} fontSize="lg">Our Services enable you to create personal Vaults that are represented as NFTs issued on the
...
Blockchains (as designated by Emblem) that may be associated with your Vault.</Text>

  <Text m={25} fontSize="lg">Emblem’s Services enable you to voluntarily interact with experimental technologies, including
...
validators.</Text>
  ...
  <Text m={25} fontSize="lg">The Services depend to a large extent on such experimental technologies and are subject to many
...
deployer, or otherwise as an ordinary user.</Text>

  <Text m={25} fontSize="lg">Blockchains may require the payment of a transaction Fee (i.e., “Gas”) for transactions executed
...
given transaction was unknown, too high, or otherwise unacceptable to a User.</Text>

  <Text m={25} fontSize="lg">You acknowledge and agree that technologies that may be available through the Service are
...
to the security of your Vault or assets.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">VI. USERS CONSENTS TO THE AUTOMATED OPERATION OF SMART CONTRACTS</Text>

<Text m={25} fontSize="lg">You agree and understand that all transactions executed by you and all fees, assets, and NFTs
...
<Text m={25} fontSize="lg">You acknowledge and agree that the Smart Contracts may be subject to bugs, malfunctions,
...
assets held in your Vault or with respect to your use or enjoyment of our Services.</Text>

<Text m={25} fontSize="lg">You agree that you have reviewed, have had the chance to audit, and hereby approve the Smart
...
https://github.com/EmblemCompany/emblem-vault-solidity/blob/RC1.1/deployed-mainnet.json.</Text>

<Text m={25} fontSize="lg">By interacting with our Smart Contracts, whether on or off of the Site, you irrevocably consent to
any foreseeable or unforeseeable function, operation, rule, parameter, or consequence enabled or
required by the Smart Contract code.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">VII. NON-RELIANCE</Text>

<Text m={25} fontSize="lg">You are knowledgeable, experienced, and sophisticated in using and evaluating blockchain and
...
in connection therewith, except as expressly set forth by Emblem in these Terms.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">VIII. ACCESSING AND USING THE SERVICE</Text>

<Text m={25} fontSize="lg">To create an Account and enjoy full functionality of our Services you must connect your third-
...
on behalf of your digital wallet.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">IX. YOUR WALLET IS YOUR SOLE RESPONSIBILITY</Text>

<Text m={25} fontSize="lg">You are solely and exclusively responsible for the security and management of your digital
...
the security of your digital wallet.</Text>

<Text m={25} fontSize="lg">You agree to notify us immediately of any actual or suspected breach of security, loss, theft, or
unauthorized use of your digital wallet or Account at hello@emblem.pro.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">X. THE SERVICES ARE PROPERTY OF EMBLEM</Text>

<Text m={25} fontSize="lg">You acknowledge and agree that Emblem owns all legal rights, title, and interest in and to all
...
in and to all aspects of Emblem’s Materials not expressly granted to you in the Terms.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XI. YOUR LICENSE TO THE SERVICES AND CONTENT</Text>

<Text m={25} fontSize="lg">You are hereby granted a limited, non-exclusive, non-transferable, revocable, non-sublicensable,
...
modification, suspension, or discontinuance of the Services.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XII. YOU MUST OBEY THE LAW</Text>

<Text m={25} fontSize="lg">You represent and warrant that you will use our Services only for purposes that are legal, proper,
...
source of traffic you send to Emblem;</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XIII. OTHER FORMS OF PROHIBITED ACTIVITY</Text>

<Text m={25} fontSize="lg">The Services relate to technologies such as Vaults, Ordinals, NFTs, Smart Contracts,
cryptocurrencies, and other technologies that present unique legal and security risks to you and
others. Accordingly, you further agree that you will not:</Text>

<List m={25} fontSize="lg">
  <ListItem ml={50} mt={5}>Use or attempt to use another’s digital wallet without authorization from such user;</ListItem>
  <ListItem ml={50} mt={5}>Pose as another person or entity, or use a wallet to engage in a transaction that is owned
or controlled, in whole or in part, by any other person;</ListItem>
   <ListItem ml={50} mt={5}>Access the Service from a different blockchain address if we’ve blocked any of your
other blockchain addresses from accessing the Service, unless you have our written
permission first;</ListItem>
   <ListItem ml={50} mt={5}>Distribute spam, including through sending unwanted assets, NFTs or Vaults to others;</ListItem>
   <ListItem ml={50} mt={5}>Use our Service for commercial purposes inconsistent with these Terms or any other
instructions;</ListItem>
   <ListItem ml={50} mt={5}>Engage in behaviors that have the intention or the effect of artificially influencing the
apparent value of a Vault or assets held therein;</ListItem>
   <ListItem ml={50} mt={5}>Attempt to sell or transfer a Vault that has already been claimed or that is otherwise not
secure;</ListItem>
   <ListItem ml={50} mt={5}>Misrepresent the contents of a Vault or otherwise provide misleading, false, or confusing
information about the contents of a Vault;</ListItem>
   <ListItem ml={50} mt={5}>Send assets to Vaults that you do not control for any unlawful purpose;</ListItem>
   <ListItem ml={50} mt={5}>Use the Service or Smart Contract to carry out any financial activities subject to
registration or licensing, including but not limited to creating, offering, selling, or buying
securities, commodities, options, or debt instruments;</ListItem>
   <ListItem ml={50} mt={5}>Use the Service to create, sell, or buy NFTs or other items that give owners rights to
participate in an ICO or any securities offering, or that are redeemable for securities,
commodities, or other financial instruments;</ListItem>
   <ListItem ml={50} mt={5}>Engage in price manipulation, fraud, or other deceptive, misleading, or manipulative
activity with respect to NFTs minted through the Services;</ListItem>
   <ListItem ml={50} mt={5}>Use the Service to buy, sell, vault, or transfer stolen items, fraudulently obtained items,
items taken without authorization, and/or any other illegally obtained items;</ListItem>
   <ListItem ml={50} mt={5}>Create or display illegal content, such as content that may involve pornographic content
or involve child sexual exploitation;</ListItem>
   <ListItem ml={50} mt={5}>Use the Service in any manner that could interfere with, disrupt, negatively affect or
inhibit other users from fully enjoying the Service;</ListItem>
   <ListItem ml={50} mt={5}>Claim assets from your Vault that are proceeds from criminal activity;</ListItem>
   <ListItem ml={50} mt={5}>Attempt to breach Emblem’s security systems or compromise the security of other
users’ digital wallets or Vaults.</ListItem>
</List>
  
<Text m={25} fontWeight={"bold"} fontSize="lg">XIV. PROHIBITED PERSONS</Text>

<Text m={25} fontSize="lg">You represent and warrant that: (i) you are not located in, ordinarily reside in, or organized under
...
territory or jurisdiction does not violate these Terms any applicable laws.</Text>

<Text m={25} fontSize="lg">Emblem may require you to provide additional information and documents in certain
...
the Service until such additional information and documents are processed by Emblem.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XV. THE EMBLEM VAULTS</Text>

<Text m={25} fontSize="lg">The Emblem Vaults are user-generated NFTs that may be controlled, modified, transferred, and
...
duty or obligation to warn you of, the status, security, or risks associated with a given Vault.</Text>

<Text m={25} fontSize="lg">Your ordinary use of the Services does not require you to give Emblem sole possession, custody,
...
interfere with your lawful ownership of your Vault.</Text>

<Text m={25} fontSize="lg">Emblem is not a wallet provider, Vault exchange, broker, financial institution, money services
...
otherwise enabled in the deployed Smart Contract code (discussed further below).</Text>

<Text m={25} fontSize="lg">YOU DEPLOY, VIEW, TRANSFER, AND BUY VAULTS AT YOUR OWN RISK,
...
VULNERABILITIES OR RISKS ASSOCIATED WITH ANY GIVEN VAULT.</Text>
      
<Text m={25} fontWeight={"bold"} fontSize="lg">XVI. FEES</Text>

<Text m={25} fontSize="lg">Emblem may impose a Vault deployment fee payable in $COVAL specified on the Site in
...
royalties or creator fees to third party marketplaces that facilitate the sale of your Vaults.</Text>
          
<Text m={25} fontWeight={"bold"} fontSize="lg">XVII. $COVAL</Text>

<Text m={25} fontSize="lg">The $COVAL (“Circuits of Value”) token is an ERC-20 token (or cryptocurrency) created and
governed by the protocol smart contract: 0x3D658390460295FB963f54dC0899cfb1c30776Df.</Text>       

<Text m={25} fontSize="lg">In its current form, $COVAL represents a unit of utility that provides you access to certain
...
buy $COVAL as a speculative investment product.</Text>         

<Text m={25} fontWeight={"bold"} fontSize="lg">XVIII. THIRD-PARTY SERVICES</Text>

<Text m={25} fontSize="lg">The Services may include hyperlinks, options, and tools to access, purchase, or interact with
...
<Text m={25} fontWeight={"bold"} fontSize="lg">XIX. YOU MUST ONLY UPLOAD OR VAULT ORIGINAL, AUTHORIZED, AND NON-INFRINGING
CONTENT</Text>

<Text m={25} fontSize="lg">By creating a Vault, uploading content through the Site, or adding NFTs to your Vault, you
...
of sales or use of the Vault or assets held therein.</Text>
      
<Text m={25} fontWeight={"bold"} fontSize="lg">XX. VAULT METADATA</Text>

<Text m={25} fontSize="lg">You must input only honest, correct, authentic, legal, and non-infringing information or metadata
...
<Text m={25} fontSize="lg">EMBLEM MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED,
...
WITH THEIR DEPLOYED VAULTS.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXI. VAULT CURATION</Text>

<Text m={25} fontSize="lg">Emblem does not generally monitor the Site for possible infringements and does not generally
...
<Text m={25} fontWeight={"bold"} fontSize="lg">XXII. YOU GRANT A LIMITED LICENSE TO EMBLEM BY USING OUR SERVICES</Text>

<Text m={25} fontSize="lg">You hereby acknowledge, understand, and agree that uploading content or adding assets to your
...
developing, marketing, and advertising the Services, your Vault, or your vaulted NFTs.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXIII. NO LEGAL OR PROFESSIONAL ADVICE</Text>

<Text m={25} fontSize="lg">The information on this Site and any information provided in connection with the Services are
...
<Text m={25} fontSize="lg">THESE TERMS DO NOT REPRESENT A COMPLETE STATEMENT OF RISK FACTORS
...
TRADE OR OTHERWISE TRANSACT IN A NFT OR DIGITAL ASSET.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXIV. INDEMNIFICATION</Text>

<Text m={25} fontSize="lg">You agree to defend, indemnify and hold harmless Emblem, its officers, directors, employees,
...
any other indemnities set forth in a written agreement between you and Emblem.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXV. DISCLAIMERS</Text>

<Text m={25} fontSize="lg">These disclaimers are provided in addition to other disclaimers expressly made or implied in
...
not hold Emblem responsible for any breach of security.</Text>

<Text m={25} fontSize="lg">We will not be responsible or liable to you for any loss and take no responsibility for any use,
...
act or omission of any Third Party service provider.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">Some jurisdictions do not allow the exclusion of certain warranties and limitations of
...
minimum permitted by such applicable law.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXVI. ACKNOWLEDGEMENTS; ASSUMPTION OF THE RISK</Text>

<Text m={25} fontSize="lg">You assume all risks concerning the Service, interactions with Smart Contracts and digital assets,
and the potential inaccuracies or errors of information or functionality provided in connection
with the Service. Without limitation, you accept and acknowledge:</Text>

<List>
  <ListItem ml={50} mt={5} fontSize="lg">The technology utilized in delivering the Services depends on experimental, public peer-
...
uncertainties.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">The Services involve the communication, encryption, and decryption of private keys
associated with your Vault that may allow Emblem to access your Vault.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">The Smart Contracts or Vaults may not function as intended and may cause a permanent
loss of your funds, or other potentially harmful consequences</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">All purchases or deployments through the Site are irreversible and non-refundable</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">The price of NFTs, Vaults, cryptocurrencies, or other digital assets are extremely volatile
and subject to change</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">You are responsible for evaluating the authenticity and credibility of Vaults. Some Vaults
may contain false or misleading information</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">You acknowledge and agree that the costs and speeds of transacting on Ethereum are
...
associated with the Service.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">Your access and use of the Services may be interrupted from time to time for any reason</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">Advances in code cracking, or technical advances such as the development of quantum
...
inaccessibility thereof.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">The regulatory regime governing blockchain technologies, non-fungible tokens,
...
value of Vaults or NFTs.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">You are solely responsible for determining what, if any, taxes apply to your transactions
...
reporting, or remitting the taxes that apply to your Vaults, assets, or NFTs.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">We do not control the public blockchains that you are interacting with and we do not
...
are irreversible and Emblem has no ability to reverse any transactions on the blockchain.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">There are risks associated with using and blockchain based services, including, but not
...
caused.</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">Our Terms and pricing, and Terms and pricing of third-party services provider and/or
vendors, may change and may result in a change to the Services</ListItem>
  <ListItem ml={50} mt={5} fontSize="lg">The media Content associated with your NFTs may be restricted and permanently
unavailable. You agree to keep a local download your Content associated with your
NFTs.</ListItem>
</List>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXVII. LIMITATION OF LIABILITY</Text>

<Text m={25} fontSize="lg">To the fullest extent permitted by law, you agree that in no event will Emblem or its service
...
computer system, NFTs, digital assets, or mobile device.</Text>

<Text m={25} fontSize="lg">Notwithstanding anything to the contrary contained herein, in no event shall the maximum
...
the above stated remedy fails of its essential purpose.</Text>

<Text m={25} fontSize="lg">Some jurisdictions do not allow the exclusion or limitation of incidental or consequential
...
limitation may not apply to personal injury claims.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">XXVIII. ARBITRATION AGREEMENT &amp; WAIVER OF CERTAIN RIGHTS, INCLUDING CLASS
ACTIONS</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">Please read this section carefully because it limits certain rights, including the right to
...
the parties must resolve those disputes directly.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">A. YOU AND EMBLEM AGREE TO BINDING ARBITRATION AND TO WAIVE A JURY TRIAL</Text>

<Text m={25} fontSize="lg">You and Emblem agree to resolve any disputes between us through binding and final arbitration,
...
right to any jury trial of any claim against you.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">Any and all disputes, controversies, claims and counterclaims, arising between You and Emblem
...
rules and regulations of securities, regulatory authorities, or other governmental agencies.</Text>

<Text m={25} fontSize="lg">This arbitration agreement does not preclude You or Emblem from seeking action by federal,
...
and You must arbitrate all Disputes.</Text>

<Text m={25} fontWeight={"bold"} fontSize="lg">B. ARBITRATION COSTS</Text>

<Text m={25} fontSize="lg">If you demonstrate that the costs of arbitration will be prohibitive as compared to the costs of
...
<Text m={25} fontWeight={"bold"} fontSize="lg">C. CLASS ACTION WAIVER</Text>

<Text m={25} fontSize="lg">You may not act as a class representative nor participate as a class member of any class
...
parties who may be similarly situated.</Text>    

<Text m={25} fontWeight={"bold"} fontSize="lg">XXIX. GOVERNING LAW AND VENUE</Text>

<Text m={25} fontSize="lg">These Terms and your access to and use of the Service shall be governed by and construed and
...
courts of Delaware.</Text>    

<Text m={25} fontWeight={"bold"} fontSize="lg">XXX. TERMINATION</Text>

<Text m={25} fontSize="lg">If you breach any of the provisions of these Terms, all licenses and privileges granted by
...
refund of any amounts that you have already paid to us.</Text>    

<Text m={25} fontWeight={"bold"} fontSize="lg">XXXI. SEVERABILITY</Text>

<Text m={25} fontSize="lg">If any term, clause, or provision of these Terms is held invalid or unenforceable, then that term,
clause, or provision will be severable from these Terms and will not affect the validity or
enforceability of any remaining part of</Text>    

<Text m={25} fontWeight={"bold"} fontSize="lg">XXXIII. EXPORT LAWS</Text>

<Text m={25} fontSize="lg">You agree that you will not export or re-export, directly or indirectly, the Service, a Vault, and/or
...
United States export laws and regulations.</Text>   

<Text m={25} fontWeight={"bold"} fontSize="lg">XXXIV. SURVIVAL</Text>

<Text m={25} fontSize="lg">All sections which by their nature should survive the termination of these Terms shall continue
...
<Text m={25} fontWeight={"bold"} fontSize="lg">XXXV. MISCELLANEOUS</Text>

<Text m={25} fontSize="lg">These Terms constitute the entire agreement between you and Emblem relating to your access to
...
<Text m={25} fontSize="lg">We reserve the right to assign our rights without restriction, including without limitation to any
...
inure to the benefit of the parties, their successors and permitted assigns.</Text>    

<Text m={25} fontSize="lg">The Service is operated by us in the United States. Those who choose to access the Service from
...
or construction of these Terms.</Text>    

<Text m={25} fontSize="lg">Except as otherwise provided herein, these Terms are intended solely for the benefit of the
parties and are not intended to confer third-party beneficiary rights upon any other person or
entity.</Text>    

<Text m={25} fontSize="lg">If you have any questions about these Terms please contact hello@emblem.pro</Text>   
